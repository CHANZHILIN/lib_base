...
/**
 * Introduce : 将信息记录到控制台的LogCat，显示调用方法及所在的文件、行号，方便开发时调试查错。
 * 注意：在Debug状态下开启，在Release状态下关闭，敏感信息不宜打印
 * Created by CHEN_ on 2018/7/10.
 **/
public class LogUtil {
    ...
    private static boolean isDebug = Constants.DEBUG_ENABLE;// 是否调试模式
